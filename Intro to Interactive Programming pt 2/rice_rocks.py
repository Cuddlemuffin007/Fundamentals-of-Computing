...
def draw(canvas):
    ...
    # handle collisions and missile impacts
...
# helper method to process sprite groups
...
# helper method to detect collisions across all objects in a group
